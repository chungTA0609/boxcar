...
export default function NotfoundItem() {
  return (
    <div className="error-section layout-radius" style={{ marginTop: "0px" }}>
        ...
        <div className="right-box">
          <div className="image-box">
            ...
            <div className="content-box">
              <h2>Không có kết quả tìm kiếm khả dụng.</h2>
              <div className="text">Vui lòng sử dụng từ khóa tìm kiếm khác</div>
